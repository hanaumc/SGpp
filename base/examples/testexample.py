...
if k == 1:
    ...
    for j in range(len(J_relevant)):
        ...
        #print(sort_edgesupp)
        #print(fullsupp)
# Versuch Punkte mit vollem Traeger und Punkte mit Randtreager gleich zu behandeln. Fehler sehr schlecht        
#         newsupp = fullsupp
#         for i in range(len(edgesupp)):
#             newsupp = np.vstack((newsupp, edgesupp[i]))
#         #print(newsupp)
#         
#         for i in range(len(newsupp)):
#             diff[i] = newsupp[i] - J_relevant[j]
