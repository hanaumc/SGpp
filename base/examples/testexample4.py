...
for levelx in range(4,8):
    for levely  in range(4,levelymax):
        ...
        eval_Interpolation_2 = np.zeros((len(punkte),1))  
        for p in range(len(punkte)):  
            ...
            for i in index_I_all: 
                ...
                f_tilde = f_tilde + alpha_2[c]*webspline
                c=c+1 
            eval_Interpolation_2[p] = f_tilde      
             
        data['eval_Interpolation_2'] = eval_Interpolation_2
